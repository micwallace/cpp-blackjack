...
/*int main(){
    ...
    game.createGame("game1", "player1");

    json jsgame = game.getGame("game1");
    cout << "JSON: " << jsgame.dump() << "\n\n";

    game.createGame("game1", "player1");

    game.joinGame("game1", "player2");

    jsgame = game.getGame("game1");
    cout << "JSON: " << jsgame.dump() << "\n\n";

    game.hit("game1", "player2");

    game.hit("game1", "player1");
